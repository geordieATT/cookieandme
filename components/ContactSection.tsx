  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch("/api/order", {
        ...
        body: JSON.stringify({ orderType: "contact", name, email, subject, message }),
      });
  ...
  return (
    <section id="contact" style={{ padding: "72px 24px" }}>
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <h2 style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 900, fontSize: 32, color: "#00205B", marginBottom: 18 }}>
          FAQs
        </h2>
          ...
          {faqItems.map((item, i) => {
            ...
            return (
              <div
                ...
                style={{ backgroundColor: "#fff", border: "2px solid #EAE4F5", borderRadius: 18, padding: "18px 20px", cursor: "pointer" }}
              >
                ...
                {isOpen && (
                  <p style={{ marginTop: 12, color: "#555", lineHeight: 1.7, fontWeight: 600 }}>{item.answer}</p>
                )}
              </div>
            );
          })}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 0.8fr", gap: 40, alignItems: "start" }}>
          <div style={{ backgroundColor: "#fff", borderRadius: 24, padding: "40px", boxShadow: "0 8px 40px rgba(0,32,91,0.08)" }}>
            ...
            {sent ? (
              <div style={{ textAlign: "center", padding: "32px 0" }}>
                ...
                <p style={{ fontWeight: 800, color: "#00205B", fontSize: 18, marginTop: 12 }}>Message sent. We'll be in touch soon.</p>
              </div>
            ) : (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            <div style={{ backgroundColor: "#F3F0FC", border: "2px solid #9B8EC4", borderRadius: 20, padding: "28px 32px" }}>
              ...
              <p style={{ color: "#555", fontWeight: 600, fontSize: 15, lineHeight: 1.7 }}>If you have an event date, logo, colour palette, or custom idea in mind, send us the details and we'll let you know what's possible.</p>
            </div>
            <div style={{ backgroundColor: "#fff", border: "2px solid #E0DCF0", borderRadius: 20, padding: "28px 32px", display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <a href="mailto:cookieandme.nz@gmail.com" style={{ color: "#C04B2B", textDecoration: "none", fontWeight: 800 }}>✉️ cookieandme.nz@gmail.com</a>
