...
const REVIEWS = [
  {
    ...
    initials: "SM",
    role: "Wedding Client",
    quote: "Absolutely stunning cookies for our wedding. Every guest was blown away by the detail on the monogram stamps. Will treasure the photos forever.",
    color: "#9B8EC4",
  },
  {
    name: "James T.",
    ...
    quote: "We ordered branded cookies for our product launch and the logo reproduction was incredible. Our team loved them and so did our clients.",
    color: "#C04B2B",
  },
  {
    name: "Aroha K.",
    initials: "AK",
    role: "Birthday Order",
    quote: "Ordered a gift box for my mum's 60th and she cried happy tears. The handwritten card was such a lovely touch. Will definitely order again.",
    color: "#00205B",
  },
];
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: "none", background: "rgba(255,255,255,0.9)", color: "#00205B",
